...
<script type="text/javascript">
   ...
   function btn1() {alert('쇼핑몰');}
   function btn2() {alert('홈페이지');}
   function btn3() {alert('네이티브 앱');}
   function btn4() {alert('서비스 개발');}
   function btn5() {alert('마케팅');}
   function btn6() {alert('유지보수');}
   function btn7() {alert('기타');}
